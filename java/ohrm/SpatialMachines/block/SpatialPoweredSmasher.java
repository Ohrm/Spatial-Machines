...
public class SpatialPoweredSmasher extends BlockContainer {
	...
	protected SpatialPoweredSmasher() {
		super(Material.anvil);
		active = false;
		setBlockName(Reference.MODID + "_" + "SpatialPoweredSmasher");
    ...
    {
        return Item.getItemFromBlock(AddedBlocks.SpatialPoweredSmasher);
    }
	
	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		
		return new TileEntitySpatialPoweredSmasher();
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
		...
		p_149727_5_.openGui(SpatialMain.instance, 2, p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_);
	...
	public void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if(tileentity instanceof TileEntitySpatialPoweredSmasher){
        	
        	if(((TileEntitySpatialPoweredSmasher) tileentity).isActive()){
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AddedBlocks.SpatialPoweredSmasher);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, AddedBlocks.SpatialPoweredSmasher);
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
        	TileEntitySpatialPoweredSmasher tileentitysmasher = (TileEntitySpatialPoweredSmasher)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (tileentitysmasher != null)
            {
                for (int i1 = 0; i1 < tileentitysmasher.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = tileentitysmasher.getStackInSlot(i1);
    ...
    {
		TileEntitySpatialPoweredSmasher tileentitysmasher = (TileEntitySpatialPoweredSmasher)world.getTileEntity(x, y, z);
        
		if (tileentitysmasher != null)
        {
        	if(tileentitysmasher.isActive()){
        		this.active = true;
